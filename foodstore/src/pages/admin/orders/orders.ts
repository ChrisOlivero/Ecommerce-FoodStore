...
const container = document.getElementById("ordersContainer") as HTMLElement;

const search = document.getElementById( "searchOrder" ) as HTMLInputElement;
...
const modal = document.getElementById("statusModal") as HTMLElement;

const selectEstado = document.getElementById("orderStatus") as HTMLSelectElement;
...
const btnCloseDetail = document.getElementById("btnCloseDetail") as HTMLButtonElement;
